...
hand = [handles[7], handles[8], handles[10], handles[9], handles[0], handles[2], handles[1], handles[6], handles[3], handles[4], handles[5]]
lab = [labels[7], labels[8], labels[10], labels[9], labels[0], labels[2], labels[1], labels[6], labels[3], labels[4], labels[5]]
plt.errorbar(X_GC_sun_kpc, b_lin, yerr = b_lin * 0.05, markersize = 8, capsize=5, elinewidth=4, capthick = 4, mfc='w', mec='w', ecolor = 'w', zorder = 2000)
plt.errorbar(X_GC_sun_kpc, b_lin, yerr = b_lin * 0.05, markersize = 8, capsize=4, elinewidth=2, capthick = 2, mfc='#047495', mec='#047495', ecolor = '#047495', zorder = 3000)
#font = FontProperties()
#font.set_weight('black')
#font.set_size('x-large')
text = ax.text(X_GC_sun_kpc-2.5, b_lin - 17, r'\textbf{systematic\,\,error}', fontsize = 15, zorder = 40, color = '#047495', ha='center', va='center') #, bbox=dict(facecolor='w', edgecolor='none', alpha=.5)) #, fontproperties=font, fontweight = 10
text.set_path_effects([path_effects.Stroke(linewidth=3, foreground='white'),
                       path_effects.Normal()])
plt.legend(hand, lab, frameon = True, fontsize = 13.5, ncol = 3, loc = 1)
plt.tight_layout()
plt.savefig('paper_rotation_curve/rotation_curve_fit_paper_literature_errorbar3.pdf', bbox_inches = 'tight')
