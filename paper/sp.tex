...
% - Add a couple of sentences in the discussion about the setting of Lambda and the parallax offset (currently 0.0483 +/- 0.012 mas)
...
This Parent Sample contains 44808 stars and is shown in \figurename~\ref{fig:parent}.
\begin{figure}
...
The \gaia\ recommended value of $\varpi_0=0.029$\,mas (\citealt{lindegren}),
but we adopt a value of $\varpi_0 = 0.048$\,mas because that value
optimizes our cross-validation likelihood.
...
Additional tests confirm that our spectroscopic parallaxes have largest scatter
...
the spectrophotometric-parallax distribution from this work for stars that are
...
\caption{The histograms of \gaia\ astrometric parallaxes $\gparallax_n$
  ...
  four stellar clusters in the \apogee\ observing footprint. The spectroscopic
...
make uncertainty estimates on the spectroscopic parallaxes.
