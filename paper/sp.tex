...
\title{Accurate spectroscopic estimates of luminosity and distance for luminous red-giant stars}
...
\gaia, \zmass, and \wise\ photometry and
continuum-normalized \apogee\ spectroscopy that predicts inverse-square-root luminosity
...
Validation with globular and open clusters shows that the spectroscopic parallax
estimates are both accurate and precise.
...
2018 NYC Gaia Sprint, hosted by the Center for Computational Astrophysics of
