...
% - CODE: change cluster plots to color vs parallax scatter plots, points colored by logg.
% - CODE: We probably should cut in color-color space. Probably in J-K vs B-R and in H-W2 vs B-R.
% - CODE: We will match axes on relevant plots.
% - CODE: we need to look at how things change with the parallax offset (0.029). It is another hyper-par.
% - CODE: we have set lambda = 50 by x-val -- final re-set?
