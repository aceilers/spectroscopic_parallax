...
For optimization, we use \code{scipy.optimize} \acronym{L-BFGS-B}, starting at
an uninformed starting point in the $\theta$ space.
The optimization is of the objective function given in \equationname~(\ref{eq:objective}) above,
...
interpretable. HOGG SHOW FIGURE THAT DEMONSTRATES THIS, qualitatively.
