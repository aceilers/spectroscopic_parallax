...
so that we never take the inverse or logarithm of a parallax, and so that
the training can be performed with full use of uncertainties and
...
We re-label each star in the sample with a new spectrophotometric parallax;
these new parallaxes have uncertainties of a few to 15 percent, depending on data quality,
