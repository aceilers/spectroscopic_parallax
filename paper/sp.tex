w%% This file is part of the spectroscopic_parallax project
...
% - draft discussion
% - write list of things we never do!
...
HOGG: LIST of things we don't do, like don't cut the sample on
astrometric quantities, and why not!! And like don't assume distance
is inverse-measured-parallax.
...
and $\chi^2(\theta)$ is the negative-log-likelihood for the parameters
...
\begin{eqnarray}
\hat{\theta} &\leftarrow& \argmin_{\theta}\left[\frac{1}{2}\,\chi(\theta)^2 + ||\lambda\cdot\theta||_1^1\right]
\quad ,
\end{eqnarray}
where
