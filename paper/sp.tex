...
% - write caption and paragraph about the new figure showing how much better we are than Gaia at large distance
...
the left-hand side is a scalar product,
and $C_m$ is the (presumed diagonal, actually) covariance matrix of the input
features.
That is, $C_m$ is a diagonal matrix with the uncertainty variances of the elements
...
HOGG CITE STASSUN MAYBE AND OTHERS?
